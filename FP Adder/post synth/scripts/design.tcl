...
set_load 10 [get_ports a_reg]
set_load 10 [get_ports b_reg]
set_load 10 [get_ports rst]
set_output_delay 0.5 -max [get_ports result_reg]
set_output_delay 0.5 -max [get_ports INF_reg]
set_output_delay 0.5 -max [get_ports NEG_INF_reg]
set_output_delay 0.5 -max [get_ports NAN_reg]
set_output_delay 0.5 -max [get_ports ERR_reg]
